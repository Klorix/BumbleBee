 ...
 <main>
	<section id="signupSection" class="Signup container-fluid position-relative" >
		<div class="container-fluid position-absolute shadow">
			<a href="login/loginDup.jsp" id="logoutBtnInSignup" style="width:5%;height:80%;top:0;bottom:0;margin:auto;right:2%;position:absolute">
                    ...
                    <div class="row" style="left: 0;right: 0;margin: auto;height:30%">
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                            	...
                            	<input type="text" class="form-control bg-transparent" id="signUpId" placeholder="Tel"
                                       style="height: 50px;">
                        ...
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="text" class="form-control bg-transparent" id="signUpName" placeholder="Tel"
                                       style="height: 50px;">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="text" class="form-control bg-transparent" id="signUpDob" placeholder="Date of Birth"
                                       style="height: 50px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="left: 0;right: 0;margin: auto;">
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="tel" class="form-control bg-transparent" id="signUpContactNo"
                                       placeholder="Tel" style="height: 50px;">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="text" class="form-control bg-transparent" id="signUpUserName"
                                       placeholder="Tel" style="height: 50px;">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="password" class="form-control bg-transparent" id="signUpPassword"
                                       placeholder="Tel" style="height: 50px;">
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="row" style="left: 0;right: 0;margin: auto;">
                        <div class="col">
                            <div class="form-floating position-relative shadow">
                                ...
                                <input type="text" class="form-control bg-transparent" id="signUpAddress"
                                       placeholder="Tel" style="height: 50px;">
                            </div>
                        </div>
                    </div>
